...
namespace Invoices.Api.Interfaces
{
    ...
    public interface IInvoiceManager
    {
        ...
        /// <summary>
        /// Vrátí seznam faktur podle zadaných filtrovacích parametrů.
        /// </summary>
        /// <param name="filter">Objekt <see cref="InvoiceFilterDto"/> s volitelnými pravidly filtrování.</param>
        /// <returns>Kolekce <see cref="InvoiceGetDto"/> odpovídající zadanému filtru.</returns>
        IEnumerable<InvoiceGetDto> FilterInvoices(InvoiceFilterDto filter);
